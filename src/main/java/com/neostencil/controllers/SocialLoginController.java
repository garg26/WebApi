...
import com.neostencil.services.FBLoginService;
import com.neostencil.services.GoogleLoginService;
...
public class SocialLoginController {
  ...
  public ResponseEntity<?> facebookLogin(@RequestParam("code") String code,
    ...
    LoginResponse loginResponse = fbLoginService.facebookLogin(code);
  ...
  public ResponseEntity<?> facebookLoginWithAccessToken(@RequestParam("token") String token,
    ...
    LoginResponse loginResponse = fbLoginService.saveLoginWithFacebook(userDetailsFromAccessToken, new LoginResponse());
    response = new ResponseEntity<>(loginResponse, HttpStatus.OK);
    return response;
  }

  @GetMapping("/google/getloginuri")
  ...
  public ResponseEntity<?> googleLogin(@RequestParam("code") String code,
    ...
    //TODO validate csrf too
    List<String> messages = new ArrayList<String>();
    LoginResponse loginResponse = googleLoginService.googleLogin(code);
    response = new ResponseEntity<>(loginResponse, HttpStatus.OK);
    return response;
  }
  ...
  public ResponseEntity<?> googleLoginWithAccessToken(@RequestBody GoogleUserDetails googleUserDetails,
    ...
    LoginResponse loginResponse = googleLoginService.saveLoginWithGoogle(googleUserDetails,new LoginResponse());
    response = new ResponseEntity<>(loginResponse, HttpStatus.OK);
    return response;
  }
