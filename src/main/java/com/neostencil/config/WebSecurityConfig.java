...
import com.neostencil.security.JwtAuthenticationEntryPoint;
import com.neostencil.security.JwtAuthorizationTokenFilter;
import com.neostencil.security.JwtTokenUtil;
import com.neostencil.security.JwtUserDetailsService;
import com.neostencil.utils.CaseInsensitiveRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        .access("hasRole('ROLE_PARENT') or hasRole('ROLE_ADMIN')");
